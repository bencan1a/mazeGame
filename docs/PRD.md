...
| #   | Risk                                                                                                                                  | Mitigation                                                                                                                                                                                                                            |
| --- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| R1  | **`bendProbability` is not natively controllable.** The contour method determines path shape; bendiness isn't a free parameter of it. | Retired: biasing spanning-tree growth toward straight continuation makes achieved bend rate track the request, monotonically, over roughly 0.06..0.48. It is a bounded band rather than a target rate, and backbite still ignores it. |
